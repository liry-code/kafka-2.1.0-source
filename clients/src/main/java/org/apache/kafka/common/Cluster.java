...
public final class Cluster {
    ...
    // todo: kafka内置topic 列表
    private final Set<String> internalTopics;
    // todo: controller控制器所在的节点
    private final Node controller;
    // todo: 每个topic 分区的信息
    private final Map<TopicPartition, PartitionInfo> partitionsByTopicPartition;
    // todo: topic 和 分区的关系， 一个topic 有哪些分区
    private final Map<String, List<PartitionInfo>> partitionsByTopic;
    // todo: topic 和 分区的关系， 一个topic 有哪些可用的分区
    private final Map<String, List<PartitionInfo>> availablePartitionsByTopic;
    // todo: PartitionInfo 和 broker之间的关系， 每个broker上都有哪些分区信息
    private final Map<Integer, List<PartitionInfo>> partitionsByNode;
    // todo: broker 和 node 的关系，比如 broker.id = 0 对应 node01 上
    ...
    private Cluster(String clusterId,
        ...
        // todo: unmodifiableList（） 不可修改List
